...
def s2_createFeatureCollection_estimates():
    with open('C:/Users/rfernand/Downloads/SL2P-PYTHON-main/SL2P-PYTHON-main/nets/SL2PENF.pkl', "rb") as fp:   #Pickling
        file = pickle.load(fp)
    fp.close()    
    return file

def s2_createFeatureCollection_errors():
    with open('C:/Users/rfernand/Downloads/SL2P-PYTHON-main/SL2P-PYTHON-main/nets/SL2PENF_error.pkl', "rb") as fp:   #Pickling
        file = pickle.load(fp)
    fp.close()    
    return file
